...
// stored credentials, or the CAPTCHA solver.
const MUGGLE_CLEARS =
...
// Real limits: no phone number is minted and TOTP is not automated. These
// claims are correct, and a gate that "corrected" them would push the model
// into promising runs that cannot happen.
const GENUINELY_UNSUPPORTED =
  /\b(?:sms|text message|phone (?:number|call)|authenticator app|google authenticator|authy|totp)\b/i;
