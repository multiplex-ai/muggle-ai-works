...
> **Validation run 1 (2026-05-21)** — scoped, author-agnostic checks only. Reviewer-dependent checks remain pending (require a non-author reviewer; deferred until a second test account is set up).
