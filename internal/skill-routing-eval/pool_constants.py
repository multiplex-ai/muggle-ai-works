...
# Twelve isolated sessions on one subscription token rate-limited each other hard enough to
# corrupt a whole sweep. Fewer workers finish slower and measure something real.
DEFAULT_ROUTING_WORKERS = 6
